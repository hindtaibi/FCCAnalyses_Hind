...
selections['finalBA']   = ["precuts", 
                           ...
                           "precuts_Za_m_Zb_m_emiss_jj_m",
                           "precuts_Za_m_Zb_m_emiss_jj_m_Za_recoil"]
...
extralabel["precuts_Za_m_Zb_m_emiss_jj_m"] = "Precuts + 80 < m(Z_{a}) < 110 + 20 < m(Z_{b}) < 80 + emiss < 8 + m(jj) > 5"
extralabel["precuts_Za_m_Zb_m_emiss_jj_m_Za_recoil"] = "Precuts + 80 < m(Z_{a}) < 110 + 20 < m(Z_{b}) < 80 + emiss < 8 + m(jj) > 5 + Za_recoil > 120"
