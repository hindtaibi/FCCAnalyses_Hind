...
cutList = {"precuts":	  			    "emiss > -10",
	   ...
	   "precuts_Za_m_Zb_m":	   		    "Za_m < 110 && Za_m > 80 && Zb_m < 80 && Zb_m > 20",  
           ...
           "precuts_Za_m_Zb_m_emiss_jj_m":	    "Za_m < 110 && Za_m > 80 && Zb_m < 80 && Zb_m > 20 && emiss < 8 && jj_m > 5",
           "precuts_Za_m_Zb_m_emiss_jj_m_Za_recoil":"Za_m < 110 && Za_m > 80 && Zb_m < 80 && Zb_m > 20 && emiss < 8 && jj_m > 5 && Za_recoil_m > 110"
           }
...
histoList = {
    ...
    "Za_e":           {"name":"Za_e",              "title":"Za_e [GeV]",                         "bin":150,  "xmin":0,      "xmax":130},
    ...
    "Za_m":           {"name":"Za_m",              "title":"Za_m [GeV]",                         "bin":150,  "xmin":0,      "xmax":120},
    "Za_recoil_m":    {"name":"Za_recoil_m",       "title":"Za_recoil_m [GeV]",                  "bin":100,  "xmin":70,     "xmax":250},
    ...
    "Zb_m":           {"name":"Zb_m",              "title":"Zb_m [GeV]",                         "bin":100,  "xmin":0,      "xmax":90},
    ...
    "jj_m":           {"name":"jj_m",          "title":"jj_m [GeV]",                         "bin":100,  "xmin":0,     "xmax":200},
