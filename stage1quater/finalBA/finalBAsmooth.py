...
if __name__ == "__main__":
    ...
    files = ["outputs/p8_ee_ZZ_ecm240_region1_histo.root", 
             "outputs/wzp6_ee_mumuH_Hbb_ecm240_region1_histo.root",
             "outputs/wzp6_ee_eeH_Hbb_ecm240_region1_histo.root",
             "outputs/wzp6_ee_eeH_Hss_ecm240_region1_histo.root",
             "outputs/wzp6_ee_mumuH_Hcc_ecm240_region1_histo.root",
             "outputs/wzp6_ee_eeH_Hcc_ecm240_region1_histo.root"]
    
    # Name of the histogram to smooth
    histogram_name = "ll2jj_m_fit"
    ...
    files = ["outputs/p8_ee_ZZ_ecm240_region2_histo.root",
             "outputs/wzp6_ee_mumuH_Hbb_ecm240_region2_histo.root",
             "outputs/wzp6_ee_eeH_Hbb_ecm240_region2_histo.root",
             "outputs/wzp6_ee_eeH_Hss_ecm240_region2_histo.root",
             "outputs/wzp6_ee_mumuH_Hcc_ecm240_region2_histo.root",
             "outputs/wzp6_ee_eeH_Hcc_ecm240_region2_histo.root"]
