...
cutList = {"precuts": 				                         "emiss > -10",
           ...
           "precuts_Z1_m_Z2_m_emiss_Z1_recoil_m":            "Z1_m < 110 && Z1_m > 80 && Z2_m < 110 && Z2_m > 80 && emiss > 8 && Z1_recoil_m > 123 && Z1_recoil_m < 130",
           "precuts_Z1_m_Z2_m_emiss_Z2_recoil_m":            "Z1_m < 110 && Z1_m > 80 && Z2_m < 110 && Z2_m > 80 && emiss > 8 && Z2_recoil_m > 125 && Z2_recoil_m < 150",
           "precuts_Z1_m_Z2_m_emiss_Z1_recoil_m_Z2_recoil_m":"Z1_m < 110 && Z1_m > 80 && Z2_m < 110 && Z2_m > 80 && emiss > 8 && Z1_recoil_m > 123 && Z1_recoil_m < 130 && Z2_recoil_m > 125 && Z2_recoil_m < 150",
           "region1":                                        "Z1_m < 110 && Z1_m > 80 && Z2_m < 110 && Z2_m > 80 && emiss > 8 && Z1_recoil_m > 123 && Z1_recoil_m < 130 && Z2_recoil_m > 125 && Z2_recoil_m < 150",
           }
...
histoList = {
    ...
    "emiss_forced":   {"name":"emiss_forced",   "title":"Forced Missing Energy [GeV]",                   "bin":150,  "xmin":0,     "xmax":150},
    ...
    "pzmiss":         {"name":"pzmiss",         "title":"p^{miss}_{z} [GeV]",                            "bin":100,  "xmin":-80,   "xmax":80},
    ...
    "jj_pt":          {"name":"jj_pt",         "title":"p_{t}(jj) [GeV]",                    "bin":100,  "xmin":0,     "xmax":70},
    ...
    "Z1_p":           {"name":"Z1_p",              "title":"p(Z_{1}) [GeV]",          			 "bin":200,  "xmin":0,      "xmax":180},
    ...
    "Z1_m":           {"name":"Z1_m",              "title":"m(Z_{1}) [GeV]",            		 "bin":100,  "xmin":0,      "xmax":130},
    "Z1_recoil_m":    {"name":"Z1_recoil_m",       "title":"m_{recoil}(Z_{1}) [GeV]",            "bin":100,  "xmin":50,     "xmax":210},
    "Z1_eta":         {"name":"Z1_eta",            "title":"#eta(Z_{1})",                        "bin":100,  "xmin":-10,    "xmax":10},
    "Z1jj_m":         {"name":"Z1jj_m",            "title":"m(Z_{1} + jj) [GeV]",                "bin":100,  "xmin":50,     "xmax":210},
    "Z1a_recoil_m":   {"name":"Z1a_recoil_m",      "title":"m_{recoil}(Z_{1} + #gamma) [GeV]",   "bin":100,  "xmin":50,     "xmax":210},
    
    "Z2_e":           {"name":"Z2_e",              "title":"E(Z_{2}) [GeV]",           			 "bin":150,  "xmin":10,     "xmax":180},
    "Z2_p":           {"name":"Z2_p",              "title":"p(Z_{2}) [GeV]",           			 "bin":200,  "xmin":0,      "xmax":180},
    ...
    "Z2_m":           {"name":"Z2_m",              "title":"m(Z_{2}) [GeV]",            		 "bin":100,  "xmin":0,      "xmax":130},
    "Z2_recoil_m":    {"name":"Z2_recoil_m",       "title":"m_{recoil}(Z_{2}) [GeV]",            "bin":150,  "xmin":50,     "xmax":210},
    "Z2_eta":         {"name":"Z2_eta",            "title":"#eta(Z_{2})",                        "bin":100,  "xmin":-10,    "xmax":10},
    "Z2a_recoil_m":   {"name":"Z2a_recoil_m",      "title":"m_{recoil}(Z_{2} + #gamma) [GeV]",   "bin":100,  "xmin":50,     "xmax":210},
    ...
    "Z2miss_m_forced":{"name":"Z2miss_m_forced",   "title":"Forced m(Z_{2} + vv) [GeV]",         "bin":160,  "xmin":50,     "xmax":210},
    "Z2miss_m_frac":  {"name":"Z2miss_m_frac",     "title":"m(Z_{2})/m(Z_{2} + #nu#nu) [GeV]",   "bin":100,  "xmin":0,      "xmax":1},
    "Z2miss_m_frac_forced":  {"name":"Z2miss_m_frac_forced",     "title":"Forced m(Z_{2})/m(Z_{2} + vv) [GeV]",   "bin":100,  "xmin":0,      "xmax":1},
    "Z2jj_m_frac":    {"name":"Z2jj_m_frac",       "title":"m(Z_{2})/m(Z_{2} + jj) [GeV]",   "bin":100,  "xmin":0,      "xmax":1},

    "ZZ_angle":       {"name":"ZZ_angle",          "title":"General Angle Between Z_{1} and Z_{2}",   "bin":100,  "xmin":-3.5,      "xmax":3.5},    
    
    "Z1_recoil_m_zoom":    {"name":"Z1_recoil_m",       "title":"m^{rec}_{ll_{1}} [GeV]",            "bin":150,  "xmin":100,    "xmax":150},
